        ...
        <div class="container mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="http://localhost/youdemy2/public/home" class="text-gray-600 hover:text-indigo-600 transition-colors">Home</a>
                    <a href="http://localhost/youdemy2/public/catalogue" class="text-gray-600 hover:text-indigo-600 transition-colors">All Courses</a>
                    <a href="http://localhost/youdemy2/public/home#about" class="text-gray-600 hover:text-indigo-600 transition-colors">About</a>
                    <a href="http://localhost/youdemy2/public/home#contact" class="text-gray-600 hover:text-indigo-600 transition-colors">Contact</a>
                </nav>
    ...
    <main class="container mx-auto px-6 md:px-12 py-10">
        ...
        <?php
            ...
            if($getCours != null && $getCours->rowCount() > 0){
                ...
                <div class="relative">
                    <img 
                        src="../img/coursImage/'.$cours['imgsrc'].'" 
                        alt="Course Image" 
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex space-x-2">
                            <a target="_blank" href="http://localhost/youdemy2/public/cour?cours='.$cours['id_cours'].'" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200">
                                Read
                            </a>
                        </div>
