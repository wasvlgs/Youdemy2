<aside class="min-w-64 bg-gradient-to-b from-indigo-600 to-indigo-800 text-white flex flex-col">
            ...
            <nav class="flex-grow py-6">
                <a href="http://localhost/youdemy2/public/teacher/dashboard" class="flex items-center px-8 py-4 text-lg hover:bg-indigo-500/50 transition-colors">
                    <i class="fas fa-chart-line w-6 mr-3"></i>
                    Dashboard
                </a>
                <a href="http://localhost/youdemy2/public/teacher/students" class="flex items-center px-8 py-4 text-lg hover:bg-indigo-500/50 transition-colors">
                    <i class="fas fa-users w-6 mr-3"></i>
                    Students
                </a>
                <a href="http://localhost/youdemy2/public/teacher/cours" class="flex items-center px-8 py-4 text-lg hover:bg-indigo-500/50 transition-colors">
