...
<body class="bg-gray-50 font-sans">
            ...
            <main class="p-6">
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <?php 
                        ...
                        <form action="http://localhost/youdemy2/public/coursCont/removeCoursAction" method="POST" class="flex justify-between">
                            <button 
                                type="button"
    ...
    <div id="addCourseModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg shadow-lg w-1/2 max-h-[95vh] overflow-auto">
            ...
            <form action="http://localhost/youdemy2/public/coursCont/addCourAction" method="POST" enctype="multipart/form-data">
    ...
    <div id="editCourseModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg shadow-lg w-1/2">
            ...
            <form action="http://localhost/youdemy2/public/coursCont/editCourAction" method="POST">
                <div class="mb-4">
