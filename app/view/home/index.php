        ...
        <div class="container mx-auto px-4 py-3">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="http://localhost/youdemy2/public/catalogue" class="text-gray-600 hover:text-indigo-600 transition-colors">Courses</a>
                ...
                <div class="flex items-center space-x-4">
                    <?php
                        ...
                        if(isset($_SESSION['id']) && isset($_SESSION['role']) && !empty($_SESSION['id']) && !empty($_SESSION['role'])){
                            if($_SESSION['role'] == 1){
                                echo '<a href="http://localhost/youdemy2/public/admin/dashboard" class="px-4 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-600/20">Dashboard</a>';
                                ...
                                echo '<a href="http://localhost/youdemy2/public/catalogue" class="px-4 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-600/20">Catalogue</a>';
                            }
                        }else{
                            echo '<a href="http://localhost/youdemy2/public/login/login" class="px-4 py-2 text-gray-600 hover:text-indigo-600 transition-colors">Log In</a>
                    <a href="login/login" class="px-4 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-600/20">Sign Up Free</a>';
                        }
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center space-y-8 animate__animated animate__fadeIn">
                ...
                <div class="max-w-2xl mx-auto">
                    <form method="GET" action="http://localhost/youdemy2/public/catalogue" class="relative">
        ...
        <div class="container mx-auto px-4">
            ...
            <?php
                    ...
                    foreach($getBestCours as $cours){
                        ...
                        <div class="relative">
                            <img src="img/coursImage/'.$cours['imgsrc'].'" alt="Course Title" class="w-full h-48 object-cover" />
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a target="_blank" href="http://localhost/youdemy2/public/cour?cours='.$cours['id_cours'].'" class="px-4 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition-colors">
                                    Get Course
                                </a>
                            </div>
