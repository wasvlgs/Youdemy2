            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="flex items-center space-x-4">
                        <a href="http://localhost/youdemy2/public/home" class="text-gray-600 hover:text-gray-900">Home</a>
                            ...
                            <?php
                                    ...
                                    if($getCategories != null && $getCategories->rowCount() > 0){
                                        foreach($getCategories as $categorie){
                                            ...
                                            <form action="http://localhost/youdemy2/public/categorieCont/removeCategorieAction" method="post" class="flex items-center space-x-2">
    ...
    <div id="addCategoryModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-md mx-4">
            <div class="p-6">
                ...
                <form method="post" action="http://localhost/youdemy2/public/categorieCont/addCategorieAction">
                    <div class="mb-4">
    ...
    <div id="editCategoryModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-md mx-4">
            <div class="p-6">
                ...
                <form method="post" action="http://localhost/youdemy2/public/categorieCont/editCategorieAction">
                    <div class="mb-4">
