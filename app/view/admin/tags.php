...
<body class="bg-gray-50 font-sans">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="http://localhost/youdemy2/public/categorie" class="text-gray-600 hover:text-gray-900">Catalogue</a>
                    </div>
                                    ...
                                    if($getTags != null && $getTags->rowCount() > 0){
                                        foreach($getTags as $tag){
                                            ...
                                            <td class="py-3 px-6">
                                                ...
                                                <form action="http://localhost/youdemy2/public/tagsCont/removeTagAction" method="POST" class="inline">
    ...
    <div class="modal-backdrop" id="modalBackdrop">
        ...
        <div class="modal" id="addTagModal">
            ...
            <form action="http://localhost/youdemy2/public/tagsCont/ajouteTagAction" method="POST">
    ...
    <div class="modal-backdrop" id="editModalBackdrop">
        ...
        <div class="modal" id="editTagModal">
            ...
            <form action="http://localhost/youdemy2/public/tagsCont/editTagAction" method="POST">
