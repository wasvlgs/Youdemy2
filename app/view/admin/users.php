<?php
    ...
    if(isset($_SESSION['id']) && isset($_SESSION['role']) && $_SESSION['role'] == 1){
        ...
        session_destroy();
        header('Location: http://localhost/youdemy2/public/login/login');
        die();
    }
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex justify-between items-center px-6 py-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="http://localhost/youdemy2/public/catalogue" class="text-gray-600 hover:text-gray-900">Catalogue</a>
                    </div>
                ...
                <div class="max-w-5xl mx-auto">
                    ...
                    <section class="mb-6">
                        ...
                        <div class="flex space-x-4">
                            <a href="http://localhost/youdemy2/public/admin/users" class="flex items-center space-x-2 bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-indigo-600">
                                <i class="fas fa-users"></i>
                                <span>Tous</span>
                            </a>
                            <a href="http://localhost/youdemy2/public/admin/users?users=teachers" class="flex items-center space-x-2 bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-indigo-600">
                                <i class="fas fa-chalkboard-teacher"></i>
                                <span>Enseignants</span>
                            </a>
                            <a href="http://localhost/youdemy2/public/admin/users?users=students" class="flex items-center space-x-2 bg-indigo-500 text-white py-2 px-4 rounded-lg hover:bg-indigo-600">
                            ...
                            <?php 
                                ...
                                if($getUsers != null && $getUsers->rowCount() > 0){
                                    foreach($getUsers as $user){
                                        ...
                                        <form action="http://localhost/youdemy2/public/usersCont/manageUserAction" method="POST" class="space-x-2">
                                            '.$buttons.'
                                        </form>
                                    </div>';
                                    }
